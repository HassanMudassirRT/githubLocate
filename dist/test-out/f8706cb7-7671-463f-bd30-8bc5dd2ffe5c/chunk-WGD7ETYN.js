...
var classes, TooltipStyle, TooltipClasses, Tooltip, TooltipModule;
var init_primeng_tooltip = __esm({
  "node_modules/primeng/fesm2022/primeng-tooltip.mjs"() {
    ...
    TooltipStyle = class _TooltipStyle extends BaseStyle {
      ...
      theme = style;
      classes = classes;
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _TooltipStyle, deps: null, target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _TooltipStyle });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: TooltipStyle, decorators: [{
      type: Injectable
    }] });
    ...
    Tooltip = class _Tooltip extends BaseComponent {
      ...
      create() {
        ...
        if (this.getOption("appendTo") === "body")
          ...
          ut(this.container, this.el.nativeElement);
        else
          ut(this.getOption("appendTo"), this.container);
      ...
      remove() {
        if (this.container && this.container.parentElement) {
          if (this.getOption("appendTo") === "body")
            ...
            Zt(this.getOption("appendTo"), this.container);
        }
        this.unbindDocumentResizeListener();
    ...
    }], ctorParameters: () => [{ type: NgZone }, { type: ViewContainerRef }], propDecorators: { tooltipPosition: [{
      type: Input
    }], tooltipEvent: [{
      type: Input
    }], positionStyle: [{
    ...
    TooltipModule = class _TooltipModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _TooltipModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.3", ngImport: core_exports, type: _TooltipModule, imports: [Tooltip], exports: [Tooltip] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _TooltipModule });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: TooltipModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [Tooltip],
        exports: [Tooltip]
...
//# sourceMappingURL=chunk-WGD7ETYN.js.map
