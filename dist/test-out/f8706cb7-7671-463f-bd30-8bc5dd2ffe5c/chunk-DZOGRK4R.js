...
// angular:jit:template:src/app/components/search-bar/search-bar.html
var search_bar_default;
var init_search_bar = __esm({
  "angular:jit:template:src/app/components/search-bar/search-bar.html"() {
    search_bar_default = '<main\n  class="flex flex-col justify-center items-center min-h-[65vh] p-4 md:p-8 lg:p-12"\n>\n  <!-- Search -->\n  <p-iconfield class="w-full max-w-4xl">\n    <p-inputicon class="pi pi-search ml-0.5" />\n    <input\n      type="text"\n      pInputText\n      pSize="large"\n      fluid\n      [formControl]="searchTerm"\n      class="text-sm md:text-base lg:text-xl"\n      placeholder="Enter GitHub username and press Enter"\n      pTooltip="Search GitHub username..."\n      tooltipPosition="top"\n    />\n  </p-iconfield>\n\n  <!-- Users List-->\n  <article\n    class="w-full max-h-[20vh] max-w-4xl flex flex-col border-t-0 border-1 border-zinc-400/40 overflow-y-scroll dark:bg-zinc-950 bg-white"\n  >\n    @if (isLoading()) {\n    <app-loader label="Fetching users..." aria-label="Loading"/>\n    } @else if (users().length !== 0) { @for (user of users(); track user.id) {\n    <app-user-search-item [user]="user" [first]="$first" />\n    }} @else if (hasSearched()) {\n    <p class="text-center my-4 text-zinc-500 dark:text-zinc-400">\n      No users found.\n    </p>\n    }\n  </article>\n</main>\n';
  }
});
...
var theme, classes, InputTextStyle, InputTextClasses, InputText, InputTextModule;
...
var classes2, IconFieldStyle, IconFieldClasses, IconField, IconFieldModule;
var init_primeng_iconfield = __esm({
  "node_modules/primeng/fesm2022/primeng-iconfield.mjs"() {
    ...
    IconFieldStyle = class _IconFieldStyle extends BaseStyle {
      ...
      theme = style2;
      classes = classes2;
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _IconFieldStyle, deps: null, target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _IconFieldStyle });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: IconFieldStyle, decorators: [{
      type: Injectable
    }] });
    ...
    IconField = class _IconField extends BaseComponent {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _IconField, deps: null, target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "20.1.3", type: _IconField, isStandalone: true, selector: "p-iconfield, p-iconField, p-icon-field", inputs: { iconPosition: "iconPosition", styleClass: "styleClass" }, host: { properties: { "class": "cn(cx('root'), styleClass)" } }, providers: [IconFieldStyle], usesInheritance: true, ngImport: core_exports, template: ` <ng-content></ng-content>`, isInline: true, dependencies: [{ kind: "ngmodule", type: CommonModule }], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: IconField, decorators: [{
      type: Component,
      args: [{
    ...
    IconFieldModule = class _IconFieldModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _IconFieldModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.3", ngImport: core_exports, type: _IconFieldModule, imports: [IconField], exports: [IconField] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _IconFieldModule, imports: [IconField] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: IconFieldModule, decorators: [{
      type: NgModule,
      args: [{
        imports: [IconField],
        exports: [IconField]
...
var classes3, InputIconStyle, InputIcon, InputIconModule;
var init_primeng_inputicon = __esm({
  "node_modules/primeng/fesm2022/primeng-inputicon.mjs"() {
    ...
    InputIconStyle = class _InputIconStyle extends BaseStyle {
      name = "inputicon";
      classes = classes3;
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIconStyle, deps: null, target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIconStyle });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: InputIconStyle, decorators: [{
      type: Injectable
    }] });
    InputIcon = class _InputIcon extends BaseComponent {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIcon, deps: null, target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "20.1.3", type: _InputIcon, isStandalone: true, selector: "p-inputicon, p-inputIcon", inputs: { styleClass: "styleClass" }, host: { properties: { "class": "cn(cx('root'), styleClass)" } }, providers: [InputIconStyle], usesInheritance: true, ngImport: core_exports, template: `<ng-content></ng-content>`, isInline: true, dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "ngmodule", type: SharedModule }], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: InputIcon, decorators: [{
      type: Component,
      args: [{
    ...
    InputIconModule = class _InputIconModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIconModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIconModule, imports: [InputIcon, SharedModule], exports: [InputIcon, SharedModule] });
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: _InputIconModule, imports: [InputIcon, SharedModule, SharedModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.1.3", ngImport: core_exports, type: InputIconModule, decorators: [{
      type: NgModule,
      args: [{
...
var init_github = __esm({
  "src/app/services/github.ts"() {
    ...
    init_http();
    init_core();
    GithubService = class GithubService2 {
      ...
      getUserRepos(username, perPage = 10, page = 1) {
        return this.http.get(`${this.apiUrl}/users/${username}/repos?per_page=${perPage}&page=${page}`);
      }
      ...
      getUserSocials(username) {
        return this.http.get(`${this.apiUrl}/users/${username}/social_accounts`);
      }
    };
...
var init_search_bar2 = __esm({
  "src/app/components/search-bar/search-bar.ts"() {
    ...
    SearchBar = class SearchBar2 {
      ...
      ngOnInit() {
        this.searchTerm.valueChanges.pipe(debounceTime(500), distinctUntilChanged(), switchMap((term) => {
          if (!term) {
            this.users.set([]);
          ...
          return this.githubService.searchUsers(term).pipe(catchError(() => {
...
export {
  ...
  init_github,
  SearchBar,
  init_search_bar2 as init_search_bar
};
...
@angular/forms/fesm2022/forms.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-DZOGRK4R.js.map
